...
import {
  Module1Content,
  Module1Intro,
} from "@/components/training/modules/Module1Content";
import {
  Module2Content,
  Module2Intro,
} from "@/components/training/modules/Module2Content";
import {
  Module3Content,
  Module3Intro,
} from "@/components/training/modules/Module3Content";
import {
  Module4Content,
  Module4Intro,
} from "@/components/training/modules/Module4Content";
import {
  Module5Content,
  Module5Intro,
} from "@/components/training/modules/Module5Content";
import {
  Module6Content,
  Module6Intro,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-10 pt-6">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Master GitHub Copilot for contextual guidance, agentic workflows,
            and safe automation.
          </p>
        </header>
